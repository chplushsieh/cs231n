...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    x, emb_cache = word_embedding_forward(captions_in, W_embed)  # (N, T, W)
    ...
    # backward pass
    dh, dW_vocab, db_vocab = temporal_affine_backward(dscores, aff_cache)
  ...
  def sample(self, features, max_length=30):
    ...
    for t in range(T):
      ...
      # prepare output
      next_word = next_word.reshape((N))  # (N,)
